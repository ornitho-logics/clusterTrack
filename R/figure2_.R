...
# Terrain is generated at one overview resolution plus one inset-specific
# resolution for each lower panel.
...
g16 =
  ...
  scf +
  scc +
  annotation_scale(height = unit(0.1, "cm"), text_cex = 0.5, location = "br") +
  tt +
