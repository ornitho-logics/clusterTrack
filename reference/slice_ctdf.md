...
#>  ⠸ 19 segments processed [2.5s]
#>  ⠼ 25 segments processed [2.8s]
#>  ⠴ 27 segments processed [2.8s]
#>  ⠦ 34 segments processed [3.1s]
#>  ⠧ 37 segments processed [3.2s]
#>  ⠇ 44 segments processed [3.5s]
#>  ⠏ 51 segments processed [3.7s]
#>  ⠋ 56 segments processed [3.9s]
#>  ⠙ 58 segments processed [4s]
#>  ⠹ 64 segments processed [4.3s]
#>  ⠸ 70 segments processed [4.5s]
#>  ⠼ 77 segments processed [4.7s]
#>  ⠴ 88 segments processed [4.9s]
